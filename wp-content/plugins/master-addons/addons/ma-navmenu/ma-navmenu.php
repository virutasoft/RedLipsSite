...
class JLTMA_Nav_Menu extends Widget_Base
{
    ...
    public function added_span_in_link($item, $depth)
    {
        ...
        if ('horizontal' === $layout || ('vertical' === $layout && 'normal' === $vertical_menu_type)) {
            $new_title .= '<span class="' . $this->get_widget_class() . '__main-item-text-wrap' . $pointer_animation_effect . '">' .
    ...
    public function get_toggle()
    {
        ...
        $this->add_render_attribute('toggle-container', 'class', array(
            ...
            'jltma-layout-' . $settings['layout'],
            'jltma-menu-dropdown-type-' . $settings['dropdown_menu_type'],
        ));
    ...
    public function get_dropdown_nav()
    {
        ...
        $this->add_render_attribute('dropdown-menu', 'class', array(
            ...
            'jltma-layout-' . $layout,
            'jltma-menu-dropdown-type-' . $dropdown_menu_type,
        ));
        ...
        if ('vertical' === $layout) {
            $this->add_render_attribute('dropdown-menu', 'class', 'jltma-vertical-type-' . $settings['vertical_menu_type']);
        }
