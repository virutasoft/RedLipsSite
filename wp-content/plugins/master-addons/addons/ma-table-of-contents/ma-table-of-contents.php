...
class JLTMA_Table_of_Contents extends Widget_Base
{
	...
	{
		return __('Table of Contents', JLTMA_TD);
	}
	...
	protected function jltma_toc_section_content()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Table of Contents', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			'ma_el_toc_title',
			array(
				'label'       => __('Enter Title Text', JLTMA_TD),
				'default'     => __('Table of Contents', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					...
					'unordered_list' => [
						'title'	=> __('Bullets', JLTMA_TD),
						'icon'	=> 'eicon-bullet-list',
					],
					'ordered_list'   => [
						'title'	=> __('Numbers', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'    => __('Heading Tags', JLTMA_TD),
				'description'    => __('Want to ignore any specific heading? Go to that heading advanced tab and enter <b>ignore-this-tag</b> class in <a href="http://prntscr.com/lvw4iy" target="_blank">CSS Classes</a> input field.', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				'label'        => __('Show Separator?', JLTMA_TD),
	...
	protected function jltma_toc_section_collapsible()
	{
		...
		$this->add_control(
			...
			array(
				'label'        => __('Make Content Collapsible', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			array(
				'label'        => __('Keep Collapsed Initially', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('Yes', JLTMA_TD),
				'label_off'    => __('No', JLTMA_TD),
				'return_value' => 'yes',
	...
	protected function jltma_toc_section_dropdown()
	{
		...
		*/
		$this->start_controls_section(
			...
			[
				'label'     => __('Dropdown Options', JLTMA_TD),
				'condition' => [
		...
		$this->add_control(
			'ma_el_toc_drop_mode',
			[
				'label'   => __('Mode', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => 'hover',
				'options' => [
					'click'    => __('Click', JLTMA_TD),
					'hover'  => __('Hover', JLTMA_TD),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __('Animation Duration', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => .3,
				],
	...
	protected function jltma_toc_section_exclude_content_controls()
	{
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => __('Add the CSS class <b>jltma-toc-hide-heading</b> to the heading you want to exclude from the table.', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => sprintf(__('%1$s Learn More » %2$s', JLTMA_TD), '<a href=https://master-addons.com/docs/exclude-specific-headings-from-table/?utm_source=jltma-pro-dashboard&utm_medium=jltma-editor-screen&utm_campaign=jltma-pro-plugin" target="_blank" rel="noopener">', '</a>'),
	...
	protected function jltma_toc_section_scroll()
	{
		...
		$this->add_control(
			...
			array(
				'label'        => __('Scroll to Top', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('Show', JLTMA_TD),
				'label_off'    => __('Hide', JLTMA_TD),
				'description'  => __('This will add a Scroll to Top arrow at the bottom of page.', JLTMA_TD),
				'return_value' => 'yes',
				'default'      => 'no',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => __('Scroll to Top Offset', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array('px'),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'jltma_toc_scroll',
			array(
				'label'        => __('Smooth Scroll', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('YES', JLTMA_TD),
				'label_off'    => __('NO', JLTMA_TD),
				'description'  => __('Smooth scroll upto destination.', JLTMA_TD),
				'return_value' => 'yes',
				'default'      => 'no',
				'separator'    => 'before',
			)
		...
		$this->add_control(
			...
			array(
				'label'      => __('Scroll Animation Delay (ms)', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array('px'),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __('Smooth Scroll Offset (px)', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array('px'),
				'range'      => [
					'px' => [
	...
	protected function jltma_toc_section_collapsible_style()
	{
		...
		*/
		...
		$this->add_control(
			...
			[
				'label'     => __('Text/Icon Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function jltma_toc_section_offcanvas_style()
	{
		...
		$this->add_control(
			'title_active_color',
			[
				'label'     => __('Active Title Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'default'   => "#54BC4B",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __('Active Border Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'default'   => "#54BC4B",
				'selectors' => [
	...
	protected function jltma_toc_section_help_docs()
	{
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/100-best-elementor-addons/" target="_blank" rel="noopener">', '</a>'),
	...
	protected function jltma_toc_section_heading_style()
	{
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => __('Title Bottom Spacing', JLTMA_TD),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min' => 0,
	...
	protected function jltma_toc_section_separator_style()
	{
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => __('Separator Bottom Spacing', JLTMA_TD),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min' => 0,
	...
	protected function jltma_toc_section_content_style()
	{
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => __('Spacing Between Content', JLTMA_TD),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min' => 0,
		...
		<div <?php echo wp_kses_post($this->get_render_attribute_string('jltma_toc_wrapper')); ?>>
			<div class="jltma-toc-wrapper">
				...
				<div class="jltma-toc-empty-note">
					<span><?php echo esc_attr__('Add a header to begin generating the table of contents', JLTMA_TD); ?></span>
				</div>
			</div>
