...
class JLTMA_Mailchimp extends Widget_Base
{
	...
	public function jltma_get_forms()
	{
		...
		$options = array(0 => __('Select Form', JLTMA_TD));
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				'label'       => __('Form Type', JLTMA_TD),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'default',
				'options'     => array(
					'default' => __('Defaults', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				'label'       => __('MailChimp Sign-Up Form', JLTMA_TD),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'default'     => 0,
		...
		$this->add_control(
			...
			array(
				'label'       => __('Custom Form', JLTMA_TD),
				'type'        => Controls_Manager::CODE,
				'language'    => 'html',
				'description' => __('Enter your custom form markup', JLTMA_TD),
				'condition'   => array(
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/mailchimp/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/mailchimp-element/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=hST5tycqCsw" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
