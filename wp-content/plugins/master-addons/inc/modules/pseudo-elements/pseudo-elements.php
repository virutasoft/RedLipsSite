...
class Extension_Pseudo_Elements
{
	...
	public function jltma_section_add_pseudo_elements_controls($widget, $section_id, $args)
	{
		...
		$widget->start_controls_section(
			...
			array(
				'label'     => JLTMA_BADGE . __(' Pseudo Elements (Developers)', JLTMA_TD),
		...
		$widget->add_control(
			...
			array(
				'raw'  => __('Adds background to pseudo elements like ::before and ::after selectors. (developers only)', JLTMA_TD),
		...
		$widget->add_control(
			...
			array(
				'label'     => __('Background ::before', JLTMA_TD),
		...
		$widget->add_control(
			...
			array(
				'label'     => __('Background ::after', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before'
			)
		);
