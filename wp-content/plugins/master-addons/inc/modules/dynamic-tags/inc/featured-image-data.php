...
class JLTMA_Featured_Image_Data extends Tag
{
	...
	{
		return esc_html__('Featured Image Data', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'attachment_data',
			[
				'label' => esc_html__('Data', JLTMA_TD),
				'type' => Controls_Manager::SELECT,
				'default' => 'title',
				'options' => [
					'title' => esc_html__('Title', JLTMA_TD),
					'alt' => esc_html__('Alt', JLTMA_TD),
					'caption' => esc_html__('Caption', JLTMA_TD),
					'description' => esc_html__('Description', JLTMA_TD),
					'src' => esc_html__('File URL', JLTMA_TD),
					'href' => esc_html__('Attachment URL', JLTMA_TD),
				],
			]
		);
	}
