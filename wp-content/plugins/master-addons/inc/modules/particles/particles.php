    ...
    if (('section' === $element->get_name() && 'section_background' === $section_id) || ('column' === $element->get_name() && 'section_style' === $section_id)) {
      ...
      $element->add_control(
        ...
        [
          ...
          'raw' => __('<a href="https://vincentgarreau.com/particles.js/" target="_blank">Click here</a> to generate JSON for the below field. </br><a href="http://bit.ly/2Zoicet" target="_blank">Know more</a> about using this feature.', JLTMA_TD),
          'separator' => 'none',
          'condition' => [
            'ma_el_enable_particles' => 'yes',
          ],
