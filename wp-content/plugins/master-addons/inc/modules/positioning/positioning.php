...
class JLTMA_Extension_Positioning
{
	...
	public function jltma_add_position_controls_section($widget, $section_id, $args)
	{
		...
		$widget->start_controls_section(
			...
			array(
				'label'     => JLTMA_BADGE . __(' Positioning', JLTMA_TD),
		...
		$widget->add_responsive_control(
			'ma_el_position_type',
			array(
				'label'       => __('Position Type', JLTMA_TD),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					''         => __('Default', JLTMA_TD),
					'static'   => __('Static', JLTMA_TD),
					'relative' => __('Relative', JLTMA_TD),
					'absolute' => __('Absolute', JLTMA_TD)
				),
				'default'      => '',
				'selectors'    => array(
		...
		$widget->add_responsive_control(
			...
			array(
				'label'      => __('From Center', JLTMA_TD),
				'description' => __('Please avoid using "From Center" and "Left" options at the same time.', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array('px', 'em', '%'),
				'range'      => array(
					'px' => array(
