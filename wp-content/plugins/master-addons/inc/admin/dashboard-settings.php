...
class Master_Addons_Admin_Settings
{
	...
	public function __construct()
	{
		...
		add_action('wp_ajax_nopriv_jltma_save_icons_library_settings', [$this, 'jltma_save_icons_library_settings']);
...
<?php }
	...
	public function jltma_save_icons_library_settings()
	{
		...
		foreach (self::jltma_addons_icons_library_array() as $value) {
			...
			if (isset($settings[$value])) {
				$this->jltma_icons_library_settings[$value] = 1;
			} else {
				$this->jltma_icons_library_settings[$value] = 0;
			}
		}
