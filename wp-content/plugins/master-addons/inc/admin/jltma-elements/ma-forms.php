...
if (!class_exists('JLTMA_Addon_Forms')) {
    class JLTMA_Addon_Forms
    {
        ...
        public function __construct()
        {
            self::$jltma_forms = [
                'jltma-forms'      => [
                    'title'     => esc_html__('Form Elements', JLTMA_TD),
                    'elements'      => [
                        [
                            'key'      => 'contact-form-7',
                            'title'    => esc_html__('Contact Form 7', JLTMA_TD),
                        ...
                        [
                            'key'      => 'ninja-forms',
                            'title'    => esc_html__('Ninja Form', JLTMA_TD),
                        ...
                        [
                            'key'      => 'wpforms',
                            'title'    => esc_html__('WP Forms', JLTMA_TD),
                        ...
                        [
                            'key'      => 'gravity-forms',
                            'title'    => esc_html__('Gravity Forms', JLTMA_TD),
                        ...
                        [
                            'key'      => 'caldera-forms',
                            'title'    => esc_html__('Caldera Forms', JLTMA_TD),
                        ...
                        [
                            'key'      => 'weforms',
                            'title'    => esc_html__('weForms', JLTMA_TD),
                        ...
                        // [
                        //     'key'      => 'fluent-form',
                        //     'title'    => esc_html__('Fluent Form', JLTMA_TD),
