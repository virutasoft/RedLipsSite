    ...
    class Master_Addons_Promotions
    {
        ...
        public function jltma_latest_update_details()
        {
            ...
            $jltma_changelog_message = sprintf(
                 ...
                 * Starts from: %3$s
                 */
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">New Addon Element "Comparison Table" released</span><br>', JLTMA_TD), //%3$s
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Counter UP Content Alignment issue fixed</span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Pro version CSS file not found issue fixed</span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Swiper Slider not working issue with Team Slider, Timeline, Blog Carousel, Logo Slider etc has been fixed</span><br>', JLTMA_TD) //%6$s
