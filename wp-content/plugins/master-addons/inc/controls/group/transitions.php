...
class MA_Group_Control_Transition extends Group_Control_Base
{
	...
	public static function get_easings()
	{
		return [
			...
			'ease-in-out' 	=> esc_html__('Ease In Out', JLTMA_TD)
		];
	}
	...
	protected function init_fields()
	{
		...
		$controls['property'] = [
			'label'			=> _x('Property', 'Transition Control', JLTMA_TD),
			'type' 			=> Controls_Manager::SELECT,
			'default' 		=> 'all',
			'options'		=> [
				'all'		=> esc_html__('All', JLTMA_TD),
			],
			'selectors' => [
		...
		$controls['easing'] = [
			'label'			=> _x('Easing', 'Transition Control', JLTMA_TD),
			'type' 			=> Controls_Manager::SELECT,
			'default' 		=> 'linear',
		...
		$controls['duration'] = [
			'label'			=> _x('Duration', 'Transition Control', JLTMA_TD),
	...
	protected function get_default_options()
	{
		return [
			'popover' => [
				...
				'starter_title' => _x('Transition', 'Transition Control', JLTMA_TD),
			],
		];
	}
}
