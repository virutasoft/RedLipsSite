...
abstract class MA_Control_Format_Date_Time extends Group_Control_Base
{
    ...
    protected function init_fields()
    {
        ...
        $fields[static::get_name_field_custom()] = array(
            ...
            'description' => sprintf(
                ...
                __('Link', JLTMA_TD),
                __('Documentation on date and time formatting', JLTMA_TD)
            ),
    ...
    protected function filter_fields()
    {
        ...
        if (!empty($args['human_readable'])) {
            $fields[static::get_name_field()]['options']['human_readable'] = __('Human Readable', JLTMA_TD);
        }
    ...
    public static function get_render_format($prefix, $settings, $timestamp)
    {
        ...
        if ('human_readable' === $format) {
            ...
            return sprintf(__('%s ago', JLTMA_TD), human_time_diff($timestamp));
        } else {
    ...
    protected static function get_format_options()
    {
        ...
        $format_i18n = array(
            '' => __('Default', JLTMA_TD) . ' - ' . date_i18n($format_general),
        );
        ...
        $format_i18n['custom'] = __('Custom', JLTMA_TD);
    ...
    {
        return __('Custom Format', JLTMA_TD);
    }
